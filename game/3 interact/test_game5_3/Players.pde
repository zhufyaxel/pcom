...
public class Warrior extends Player {
  ...
  Warrior(float x, float y, float w, float h, int b) {
    ...
    warriorAtt[0] = loadImage("images/characters/zhu_att0.png");
    warriorAtt[1] = loadImage("images/characters/zhu_att0.png");
    warriorAtt[2] = loadImage("images/characters/zhu_att0.png");
    warriorAtt[3] = loadImage("images/characters/zhu_att0.png");
  }
